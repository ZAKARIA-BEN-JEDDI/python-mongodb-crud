...
class Commande:
    def afficher_interface3(self):
        ...
        #TODO title
        self.page3.title("COMMANDE")
        #TODO self.page3 not resizable
        self.page3.resizable(False,False)
        #TODO titre de la self.page3
        # self.p3_titre_brand = Label(self.page3,pady=0,text="COMMANDES",background='#253342',fg="#fff",font=self.p3_nouvelle_police)
        # self.p3_titre_brand.pack()
        #! CHAMP DE SAISIE
        
        # self.combobox_asc.place(x=880, y=150)
        ...
        #COMBO ID_CLIENT
        #todo self.option_id_client = [row[0] for row in db_command.get_id_client()]
        #todo self.id_client_combo = tk.StringVar()
        #COMBO ID_PRODUIT
        #todo self.option_id_produit = [row[0] for row in db_command.get_id_produit()]
        #todo self.id_produit_combo = tk.StringVar()

        self.id_client_label = Label(self.page3,text="id client",background="#253342",fg="#fff",font=self.p3_font_champ)
        # self.combobox_asc = ttk.Combobox(self.page3,textvariable=self.id_client_combo,values=self.option_id_client)
        self.id_client_entrer = Entry(self.page3,border=1,width=20) #TODO le cas de modification
        self.id_produit_label = Label(self.page3,text="id produit",background="#253342",fg="#fff",font=self.p3_font_champ)
        # self.id_produit_entrer = ttk.Combobox(self.page3,textvariable=self.id_produit_combo,values=self.option_id_produit)
        self.id_produit_entrer = Entry(self.page3,border=1,width=20)#TODO le cas de modification
    ...
    def show_input(self):
        ...
        # self.combobox_asc.place(x=300, y=115)
    ...
    def ajouter(self):
        ...
        if id_command == '' or id_client == '' or id_produit == '' or qte == '' or date == '':
            ...
            # print(type(self.id_command))
            # self.id_command = int(self.id_command)
            # self.id_produit =  int(self.id_produit)
            # self.id_client =  int(self.id_client)
            # self.qte =  float(self.qte)
            # print(type(self.id_client))
            # print(type(self.qte))
            # if type(self.id_command) == int and type(self.id_client) == int and type(self.qte) == float and type(self.id_produit) == int :
    ...
    # def placer_entrer_id(self):
    #     self.id_produit_entrer.place(x=300 ,y=75)
    #     self.id_client_entrer.place(x=300,y=115)
    #     self.id_produit_entrer.place(x=-300,y=-75)
    #     self.id_client_combo.place(x=-300,y=-115)

    def modifier(self):
        id_command = int(self.id_commande_entrey.get())
        # id_client = int(self.id_client_combo.get())
    ...
    def afficher_command_client(self):
        ...
        if id_client != '':
            ...
            tkinter.messagebox.showerror('',"ENTRER L'IDENTIFIANT DE CLIENT !")
            self.remplir_tableau()
    ...
    def table3(self):
        ...
        # self.p3_table3.column('NOM CLIENT',anchor=tk.CENTER,width=250)
        self.p3_table3.column('ID PRODUIT',anchor=tk.CENTER,width=250)
        # self.p3_table3.column('NOM PRODUIT',anchor=tk.CENTER,width=250)
        ...
        # self.p3_table3.heading('NOM CLIENT',text='NOM CLIENT')
        self.p3_table3.heading('ID PRODUIT',text='ID PRODUIT')
        # self.p3_table3.heading('NOM PRODUIT',text='NOM PRODUIT')
